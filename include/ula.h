...
SC_MODULE(ULA) {
  ...
  sc_out<bool>       flag_negativo;

  // Método combinacional para realizar as operações da ULA com base no controle recebido  
  void calcular() {
    ...
    case 2: res = a + b; break; // ADD
    case 3: res = a ^ b; break; // XOR
    case 4: res = ~a; break;    // NOT
    case 6: res = a - b; break; // SUB
    case 7: res = a - b; break; // CMP
    default: res = 0; break;
    }
